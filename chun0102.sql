...
SELECT student_no 학번, student_name 이름, to_date(entrance_date,'yyyy-mm-dd') 입학년도 from tb_student
where department_no = 002 order by entrance_date desc;
